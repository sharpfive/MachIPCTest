...
int main(void) {
    ...
    mach_vm_address_t      address = 0;
     ...
     printf("memory allocated at %p\n", (void *)address);     // Create a named entry corresponding to the given mapped portion of our
     ...
     kr = mach_make_memory_entry_64(
         ...
         (mem_entry_name_port_t)NULL);            // parent handle     // ideally we should vm_deallocate() before we exit
